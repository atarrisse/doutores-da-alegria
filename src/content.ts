...
const CONTENT: Array<CONTENT_SECTION> = [
  ...
  },
  {
    ...
    color: COLORS.BLUE,
    content: [
      "No palco do samba, Doutores da Alegria [foi homenageada pela Escola de Samba Dragões da Real](). No dia 21 de fevereiro, a agremiação do Grupo Especial levou o enredo “A Revolução do Riso: A Arte de Subverter O Mundo Pelo Divino Poder da Alegria” para o Sambódromo do Anhembi, em São Paulo.",
